...
export default class ipadSearchPage extends Component{
    constructor(props){
        super(props);
        this.state = {
            input: "",
	...
	return (
		<div>
            ...
            <div>
                ...
                <Button class={ style_ipad.button } clickFunction={()=>{this.state.name_callback(this.state.input)}} Text="Display weather"/>
